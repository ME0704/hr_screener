def generate_summary(
    ...
    exp_line = (
        f"{years_of_experience} years experience"
    ...
    edu_map = {
        ...
        "alevel": "A-Level",
        "olevel": "O-Level",
        "unknown": "Education not detected"
    }
    ...
    uganda_str = ". ".join(uganda_insights) if uganda_insights else "No local credentials detected"
    ...
    summary = (
        ...
        f"Local insights: {uganda_str}. "
        f"CV quality: {quality_str}. "
        f"Score breakdown — "
        f"Skills: {breakdown['skills']}/25, "
        ...
        f"Uganda Bonus: {breakdown['uganda_bonus']}/15."
    )
